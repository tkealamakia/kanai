...
export const TagUpdate = (props: ITagUpdateProps) => {
  ...
  const { tagEntity, documents, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="kanaiApp.tag.home.createOrEditLabel">
            <Translate contentKey="kanaiApp.tag.home.createOrEditLabel">Create or edit a Tag</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : tagEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="tag-name">
                  <Translate contentKey="kanaiApp.tag.name">Name</Translate>
                </Label>
                <AvField
                  id="tag-name"
                  type="text"
