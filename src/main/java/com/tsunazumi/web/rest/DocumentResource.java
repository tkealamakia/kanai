...
/**
 * REST controller for managing {@link com.tsunazumi.domain.Document}.
 */
@RestController
@RequestMapping("/api")
public class DocumentResource {
    ...
    public ResponseEntity<List<Document>> getAllDocuments(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
